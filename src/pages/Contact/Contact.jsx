  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        'http://localhost:8080/api/v1/submit-message',
        {
          method: 'POST',
          headers: {
      ...
      <section className="section-pad pt-20 pb-16 md:pt-28">
        <div className="container-page max-w-2xl">
          <Section>
            ...
            <h1 className="font-display font-bold text-4xl md:text-6xl text-ink-50 mt-5 leading-tight">
              Let&rsquo;s talk about your project.
            </h1>

            <p className="text-ink-400 text-lg leading-relaxed mt-6">
              Tell us what you&rsquo;re building, and we&rsquo;ll follow up to
              talk through it.
            </p>
          </Section>
        </div>
          ...
          <Section>
            ...
            >
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label className="text-xs font-mono uppercase tracking-wide text-ink-500 block mb-2">
                    Full Name *
                  </label>
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-ink-100 focus:border-electric-400 outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-ink-100 focus:border-electric-400 outline-none transition-colors resize-none"
          ...
          <Section delay={120} className="space-y-5">
            <div className="card p-6">
              ...
              <a
                ...
                className="text-ink-100 hover:text-electric-300 transition-colors"
              >
                {company.email}
              </a>
            </div>
